...
DisableInteriorProp(int_plan1, "set_plan_computer") --comp
DisableInteriorProp(int_plan1, "set_plan_keypad")

DisableInteriorProp(int_plan1, "set_plan_hacker")
EnableInteriorProp(int_plan1, "set_plan_mechanic")
DisableInteriorProp(int_plan1, "set_plan_weapons")

DisableInteriorProp(int_plan1, "set_plan_vault")
DisableInteriorProp(int_plan1, "set_plan_wall") --stone wall
DisableInteriorProp(int_plan1, "set_plan_setup") --light for plan
...
DisableInteriorProp(int_plan1, "set_plan_scribbles")
EnableInteriorProp(int_plan1, "set_plan_arcade_x4")
DisableInteriorProp(int_plan1, "set_plan_plans")
DisableInteriorProp(int_plan1, "set_plan_plastic_explosives")
DisableInteriorProp(int_plan1, "set_plan_cockroaches")
DisableInteriorProp(int_plan1, "set_plan_electric_drill")
DisableInteriorProp(int_plan1, "set_plan_vault_drill")
DisableInteriorProp(int_plan1, "set_plan_vault_laser")
DisableInteriorProp(int_plan1, "set_plan_stealth_outfits")
DisableInteriorProp(int_plan1, "set_plan_hacking_device")
DisableInteriorProp(int_plan1, "set_plan_gruppe_sechs_outfits")
DisableInteriorProp(int_plan1, "set_plan_fireman_helmet")
DisableInteriorProp(int_plan1, "set_plan_drone_parts")
DisableInteriorProp(int_plan1, "set_plan_vault_keycard_01a")
DisableInteriorProp(int_plan1, "set_plan_swipe_card_01b")
DisableInteriorProp(int_plan1, "set_plan_swipe_card_01a")
DisableInteriorProp(int_plan1, "set_plan_vault_drill_alt")
DisableInteriorProp(int_plan1, "set_plan_vault_laser_alt")
