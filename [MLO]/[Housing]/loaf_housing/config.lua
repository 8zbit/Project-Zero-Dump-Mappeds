...
Strings = {
    ...
    ['Manage_House'] = 'Administra tu casa',
    ['Buy_House'] = 'Comprar casa #%s',
    ['Knock_House'] = 'Llamar a la puerta',
    ['Your_House'] = 'Tu casa',
    ['Buyable_House'] = 'Casa en venta',
    ['Player_House'] = 'Casa de alguien',
    ['Storage'] = 'Accede a tu inventario',
    ['Sell_House'] = 'Vender por $%s',
    ['Enter_House'] = 'Entrar en casa',
    ['Sell_Confirm'] = 'Vender casa por $%s?',
    ['yes'] = 'Si',
    ['no'] = 'No',
    ['Sold_House'] = 'Has vendido la casa por $%s',
    ['Must_Sell'] = 'Solo puedes tener una casa. Vende la que tienes para adquirir una nueva.',
    ['Buy_House_Confirm'] = 'Comprar casa #%s por $%s?',
    ['Manage_Door'] = 'Administrar puerta',
    ['Accept'] = 'Dejar entrar a alguien',
    ['Exit'] = 'Salir de casa',
    ['Noone_Home'] = 'Parece que no hay nadie en casa!',
    ['Someone_Knocked'] = 'Alguien ha tocado el timbre. Ve a la puerta para abrirle!',
    ['Let_In'] = 'Dejar que entre alguien',
    ['Accept_Player'] = 'Dejar a %s entrar?',
    ['Waiting_Owner'] = 'Esperando al propietario para que te deje entrar.',
    ['ikea'] = 'IKEA',
    ['Buy_Furniture'] = 'Comprar muebles en IKEA',
    ...
    ['Furnish'] = 'Amuebla tu casa',
    ['Store_Garage'] = 'Presiona ~INPUT_CONTEXT~ para guardar un vehiculo.', 
    ['Re_Furnish'] = 'Recojer muebles colocados',
    ['Remove'] = 'Recojer %s (#%s)',
    ['Amount'] = 'Cuantos?',
    ['Player_Inventory'] = 'Tu inventario',
    ['House_Inventory'] = 'Inventario',
    ['Invalid_Amount'] = 'Cantidad invalida. Introduce un numero.',
    ['Store'] = 'Guardar',
    ['Withdraw'] = 'Sacar',
    ['Storage_Title'] = 'Armario',
    ['You_Stored'] = 'Has guardado %sx %s',
    ['You_Withdrew'] = 'Has sacado %sx %s',
    ['Not_Enough'] = 'No tienes tanto de eso!',
    ['Not_Enough_House'] = 'No tienes tanto de eso en el armario!',
    ['Weapons'] = 'Armas',
    ['Items'] = 'Objetos',
    ['No_Weapon'] = 'No tienes esa arma en tu inventario!',
    ['bullets'] = 'Municion', 
    ['Rotation'] = 'Rotacion',
    ['Guests'] = 'Tus invitados tienen que abandonar el domicilio para que puedas hacer eso.',
    ['Garage'] = 'Entrar al garaje',
    ['No_Spawn'] = 'No se ha encontrado un punto de spawn en tu casa.',
    ['Host_Left'] = 'El propietario de la casa ha salido, abandonaras la casa en breve.',
    ['No_Money'] = 'No tienes suficiente dinero!',
    ['Furnishing'] = '~INPUT_CELLPHONE_LEFT~ ~INPUT_CELLPHONE_RIGHT~ ~INPUT_CELLPHONE_DOWN~ ~INPUT_CELLPHONE_UP~ Mover\n~INPUT_VEH_CINEMATIC_UP_ONLY~ ~INPUT_VEH_CINEMATIC_DOWN_ONLY~ Altura\n~INPUT_ATTACK~ ~INPUT_AIM~ Rotar\n~INPUT_DETONATE~ Colocar en el suelo\n~INPUT_FRONTEND_ENDSCREEN_ACCEPT~ Colocar\n~INPUT_FRONTEND_CANCEL~ Cancelar'
}